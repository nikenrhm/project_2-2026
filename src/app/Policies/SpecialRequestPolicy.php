...
class SpecialRequestPolicy
{
    ...
    {
        return $user->can('view_any_special::request');
    }
    ...
    {
        return $user->can('view_special::request');
    }
    ...
    {
        return $user->can('create_special::request');
    }
    ...
    {
        return $user->can('update_special::request');
    }
    ...
    {
        return $user->can('delete_special::request');
    }
    ...
    {
        return $user->can('delete_any_special::request');
    }
     ...
     */
    public function replicate(User $user, SpecialRequest $specialRequest): bool
    {
